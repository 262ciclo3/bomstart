# S15 - Sustentación de la base de datos relacional
...
Sustentar diseño, implementación, consultas, validación e integración de la base de datos del proyecto.

### 1.2 Resultado de aprendizaje

El estudiante defiende la base de datos relacional como soporte técnico del sistema web.

### 1.3 Producto de sesión

Base de datos relacional sustentada con scripts y evidencias.

### 1.4 Motivación de la sesión

La sustentación debe demostrar que la base no solo existe, sino que responde al problema y soporta la aplicación.
...
1. Preparar evidencias finales
2. Ensayar demo SQL
3. Documentar aporte individual
...
1. ¿Qué decisión de modelo fue clave?
2. ¿Qué script reconstruye la base?
3. ¿Qué consulta demuestra valor?
4. ¿Qué consume LP1?
5. ¿Qué hiciste tú?
