# S8 - Manipulación de datos con SQL DML
...
Cargar y modificar datos de prueba usando DML para validar tablas, relaciones y reglas de integridad.

### 1.2 Resultado de aprendizaje

El estudiante ejecuta INSERT, UPDATE y DELETE respetando relaciones e integridad.

### 1.3 Producto de sesión

Script DML con datos de prueba coherentes.

### 1.4 Motivación de la sesión

Sin datos de prueba no se puede validar consultas ni conexión con LP1.
...
2. Insertar tablas maestras
3. Insertar transacciones
4. Actualizar registros
5. Eliminar registros controlados
...
1. Crear script DML
2. Cargar datos desde cero
3. Probar errores de FK
4. Documentar dataset mínimo
5. Relacionar con vistas LP1
...
1. ¿Qué dato semilla es indispensable?
2. ¿Qué pasa si falla una FK?
3. ¿Qué registro actualizaste?
4. ¿Qué datos necesita LP1?
5. ¿Qué escenario de REQ probaste?
