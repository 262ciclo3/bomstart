# S13 - Integración del modelo conceptual y lógico
...
Consolidar modelos conceptual y lógico finales según cambios del sistema y evidencias de implementación.

### 1.2 Resultado de aprendizaje

El estudiante ajusta modelos finales para que coincidan con scripts, consultas y aplicación.

### 1.3 Producto de sesión

Modelo conceptual y lógico final integrado.

### 1.4 Motivación de la sesión

Al final del curso, el modelo debe reflejar lo construido y no una versión antigua.
...
1. Comparar ER con scripts
2. Comparar lógico con DDL
3. Comparar consultas con requerimientos
4. Registrar cambios
...
1. Actualizar modelos finales
2. Documentar cambios
3. Preparar evidencia de consistencia
4. Relacionar con SRS
...
1. ¿Qué cambió del modelo inicial?
2. ¿Qué tabla refleja una regla?
3. ¿Qué consulta evidencia un requerimiento?
4. ¿Qué usa LP1?
5. ¿Qué falta cerrar?
