# S10 - Consultas multitabla y reportes
...
Construir consultas con JOIN y reportes operativos a partir de entidades maestras y transaccionales.

### 1.2 Resultado de aprendizaje

El estudiante integra tablas relacionadas para generar información útil del negocio.

### 1.3 Producto de sesión

Consultas multitabla y reportes SQL del proyecto.

### 1.4 Motivación de la sesión

Los reportes muestran valor real del sistema: no solo registros, sino información integrada.
...
3. Crear JOIN
4. Agregar filtros
5. Agregar agregaciones
6. Validar resultados
7. Documentar reporte
8. Relacionar con LP1
...
1. Crear tres reportes SQL
2. Probar resultados
3. Vincular reportes con requerimientos
4. Preparar capturas
5. Explicar uso en LP1
...
1. ¿Qué tablas integra tu reporte?
2. ¿Qué JOIN usaste?
3. ¿Qué necesidad responde?
4. ¿Cómo lo verá LP1?
5. ¿Qué error de duplicidad corregiste?
