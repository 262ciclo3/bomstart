# S15 - Sustentación técnica del proyecto
...
Sustentar técnicamente el Sistema Web MVC Empresarial, demostrando funcionamiento, arquitectura, datos, pruebas e integración con REQ y BD1.

### 1.2 Resultado de aprendizaje

El estudiante defiende el producto final, evidencia aporte individual y ejecuta una demo funcional.

### 1.3 Producto de sesión

Producto final: Sistema Web MVC Empresarial sustentado técnicamente.

### 1.4 Motivación de la sesión

La sustentación demuestra que el sistema resuelve una necesidad y que el equipo comprende su arquitectura.
...
4. Mostrar base integrada
5. Mostrar pruebas
6. Defender decisiones
...
5. Documentar aporte individual
...
2. ¿Qué flujo demostrarás?
3. ¿Cómo se conecta a BD1?
4. ¿Qué requerimiento cumple?
5. ¿Qué hiciste tú?
