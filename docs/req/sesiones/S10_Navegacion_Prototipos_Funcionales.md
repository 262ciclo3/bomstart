# S10 - Navegación y prototipos funcionales
...
Refinar navegación, pantallas y prototipos funcionales del sistema a partir de historias, casos de uso, RNF y reglas de negocio.

### 1.2 Resultado de aprendizaje

El estudiante actualiza prototipos y mapa de navegación para reflejar flujos reales del sistema.

### 1.3 Producto de sesión

Mapa de navegación y prototipos funcionales ajustados.

### 1.4 Motivación de la sesión

Ahora el prototipo ya no solo muestra pantallas; debe expresar rutas, estados, mensajes y decisiones del flujo.
...
1. Revisar casos de uso
2. Definir navegación principal
3. Refinar pantallas
4. Agregar mensajes
5. Agregar estados de error
6. Relacionar con reglas
7. Validar con LP1
...
1. Actualizar prototipo funcional
2. Crear mapa de navegación
3. Vincular pantallas con casos de uso
4. Registrar mensajes
5. Documentar cambios para LP1
...
1. ¿Qué ruta representa el flujo principal?
2. ¿Qué pantalla cambió?
3. ¿Qué dato requiere la pantalla?
4. ¿Qué regla se muestra como mensaje?
5. ¿Qué implementa LP1?
