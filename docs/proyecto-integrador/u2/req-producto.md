...
| HU-05 | Como administrador, quiero que solo usuarios autorizados gestionen pedidos. | Media | El modulo solicita un acceso basico antes de mostrar las operaciones. |
